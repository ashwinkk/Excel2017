...
class Gallery extends React.Component {
  ...
  imageView(e){        
    ...
    let orientation = (window.innerWidth-viewPosition.width)<(window.innerHeight-viewPosition.height)? "landscape":"portrait";
    ...
    this.setState((prevState,props)=>{
      return {
        ...prevState,
        imageStyle: {
          transform: "translate("+(this.thumbPosition.left-viewPosition.left)+"px,"+(this.thumbPosition.top-viewPosition.top)+"px)scale("+this.scale+")"
        }
      };
    });
    let animatedStyle = "";
    ...
    setTimeout(()=>{
    this.setState((prevState,props)=>{
      this.viewPosition = document.getElementById("viewport-image").getBoundingClientRect();
      return {
        ...prevState,
        imageStyle: {
          transition: "all 0.5s",
  ...
  handleClose(){
    let viewPosition = document.getElementById("viewport-image").getBoundingClientRect();
  ...
  render() {
    ...
    return (
      <div className="gallery-container" id="gallery-container" style={{width:pos}}>
