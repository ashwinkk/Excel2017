                ...
                <div className="root-section" style={{position:"relative", background: "linear-gradient(#ffffff, #00b0ff)", verticalAlign: "middle", paddingTop:"100px"}}>
                    <div className="about-section-box">
                        <Parallax
                            ...
                            tag="figure"
                        >
                            <img src="/static/images/excelhighres.png" style={{width:"100%", position: "relative", top: "50px"}}></img>
                        </Parallax>
                    </div>
                    <div className="about-section-box">
                        <Parallax
                            ...
                            tag="figure"
                        >
                        <div className="about-section-subbox"><h1>About</h1></div>
                        <div className="about-section-subbox"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p></div>
                        </Parallax>
                    </div>
                </div>
        );
